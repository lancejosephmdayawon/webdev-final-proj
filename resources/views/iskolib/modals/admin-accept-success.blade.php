<div id="adminAcceptSuccessModal" class="confirm-overlay" style="display: none;">
    <div class="popup-success">
        <div class="align-center">
            <img src="{{ asset('images/success.png') }}" class="success-img">
        </div>
        <h2 class="my-2">Request Accepted Successfully!</h2>

        <div class="popup-btn mt-4">
            <button class="btn-confirm-success" onclick="closeSuccessAccModal()">Confirm</button>
        </div>
    </div>
</div>
