<div id="userBorrowFormConModal" class="confirm-overlay" style="display: none;">
    <div class="popup-confirm">
        <div class="align-center">
            <img src="{{ asset('images/borrow-con.png') }}" class="borrow-con-img">
        </div>
        <h2 class="my-2">Please review your information and confirm to complete your submission.</h2>
