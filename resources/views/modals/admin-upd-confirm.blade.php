<div id="updConModal" class="confirm-overlay" style="display: none;">
    <div class="popup-confirm">
        <div class="align-center">
            <img src="{{ asset('images/upd-con.png') }}" class="upd-con-img">
        </div>
        <h2 class="my-2">Are you sure you want to update this book?</h2>

        <div class="popup-btn mt-4">
            <button class="btn-confirm" onclick="confirmUpd()">Confirm</button>
