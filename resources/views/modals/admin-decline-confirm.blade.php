<div id="adminDeclineConModal" class="confirm-overlay" style="display: none;">
    <div class="popup-confirm">
        <div class="align-center">
            <img src="{{ asset('images/add-con.png') }}" class="add-con-img">
        </div>
        <h2 class="my-2">Are you sure you want to decline the book request?</h2>

        <div class="popup-btn mt-4">
            <button class="btn-confirm" onclick="confirmDec()">Confirm</button>
            <button class="btn-cancel" onclick="closeConfirmDecModal()">Cancel</button>
        </div>
    </div>
</div>
