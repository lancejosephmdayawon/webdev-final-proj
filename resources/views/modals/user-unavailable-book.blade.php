<div id="outOfStockModal" class="confirm-overlay" style="display: none;">
    <div class="popup-success">
        <div class="align-center">
            <img src="{{ asset('images/del-con.png') }}" class="success-img">
        </div>
        <h2 class="my-2">Book Out of Stock!</h2>

        <div class="popup-btn mt-4">
            <button class="btn-confirm-success" onclick="closeOutOfStockModal()">Okay</button>
        </div>
    </div>
</div>
